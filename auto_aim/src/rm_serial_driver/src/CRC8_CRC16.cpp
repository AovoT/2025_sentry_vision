...
/**
  ...
  * @retval         计算完的CRC8
  */
uint8_t get_CRC8_check_sum(const uint8_t * pch_message, unsigned int dw_length, uint8_t ucCRC8)
{
    uint8_t uc_index;
    while (dw_length--) {
...
/**
  ...
  * @retval         真或者假
  */
uint32_t verify_CRC8_check_sum(const uint8_t * pch_message, unsigned int dw_length)
{
